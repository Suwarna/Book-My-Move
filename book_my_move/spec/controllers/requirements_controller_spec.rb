...
describe RequirementsController do
  ...
  let(:valid_attributes) { { "requirement_date" => "2015-03-19 15:37:30" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved requirement as @requirement" do
        ...
        post :create, {:requirement => { "requirement_date" => "invalid value" }}, valid_session
        assigns(:requirement).should be_a_new(Requirement)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested requirement" do
        ...
        Requirement.any_instance.should_receive(:update).with({ "requirement_date" => "2015-03-19 15:37:30" })
        put :update, {:id => requirement.to_param, :requirement => { "requirement_date" => "2015-03-19 15:37:30" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the requirement as @requirement" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Requirement.any_instance.stub(:save).and_return(false)
        put :update, {:id => requirement.to_param, :requirement => { "requirement_date" => "invalid value" }}, valid_session
        assigns(:requirement).should eq(requirement)
      end
