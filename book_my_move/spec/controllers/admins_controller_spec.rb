...
describe AdminsController do
  ...
  let(:valid_attributes) { { "admin_fname" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved admin as @admin" do
        ...
        post :create, {:admin => { "admin_fname" => "invalid value" }}, valid_session
        assigns(:admin).should be_a_new(Admin)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested admin" do
        ...
        Admin.any_instance.should_receive(:update).with({ "admin_fname" => "MyString" })
        put :update, {:id => admin.to_param, :admin => { "admin_fname" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the admin as @admin" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Admin.any_instance.stub(:save).and_return(false)
        put :update, {:id => admin.to_param, :admin => { "admin_fname" => "invalid value" }}, valid_session
        assigns(:admin).should eq(admin)
      end
